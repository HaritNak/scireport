...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-address-book"></i> จัดการสมาชิก</h1>
        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">จัดการสมาชิก&nbsp;&nbsp;<a href='insert_member.php' class='btn btn-primary' role='button' aria-pressed='true'>เพิ่มสมาชิก</a></h3>
                <table class=" table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $sql_select_member = "SELECT * FROM member ";
                        ...
                        if (!$result_select_member) {
                            ...
                            while ($row_select_member = mysqli_fetch_array($result_select_member)) {
                                echo "<tr>";
                                echo "<td>" . $row_select_member['mid'] . "</td>";
                                echo "<td>" . $row_select_member['position'] . "</td>";
                                echo "<td>" . $row_select_member['firstname'] . "</td>";
                                echo "<td>" . $row_select_member['lastname'] . "</td>";
                                echo "<td>" . $row_select_member['major'] . "</td>";
                                echo "<td>" . $row_select_member['area'] . "</td>";
                                echo "<td>" . $row_select_member['email'] . "</td>";
                                echo "<td>" . $row_select_member['password'] . "</td>";
                                echo "<td>" . $row_select_member['phone'] . "</td>";
                                echo "<td>" . $row_select_member['status'] . "</td>";
                                echo "<td><a href='edit_member.php?id=" . $row_select_member['mid'] . "' class='btn btn-warning' role='button' aria-pressed='true'>แก้ไข</a></td>";
                                echo "<td><a href='delete_member.php?id=" . $row_select_member['mid'] . "' onclick=\"return confirm('คุณต้องการลบสมาชิกนี้หรือไม่? !!!')\" class='btn btn-danger' role='button' aria-pressed='true'>ลบ</a></td>";
                                echo "</tr>";
                            }
                        }
                        ?>
