...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-th-list"></i> สรุปผลดำเนินงาน<?php echo $row_select_operation['o_name'] ?> ปีงบประมาณ <?php echo $fiscal_year ?></h1>
            ...
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="sammary_report_indicator.php?year=<?php echo $fiscal_year ?>&&o_id=<?php echo $o_id ?>">สรุปผลดำเนินงาน<?php echo $row_select_operation['o_name'] ?></a></li>
            </ul>
        </div>
        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">สรุปผลตัวชี้วัดย่อย <?php echo $row_select_operation['i_name'] ?></h3>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $sql_select_sub_indicator = "SELECT s.s_id,s.s_name,s.s_goal,q.q_full,q.q_present FROM $table_sub_indicator_name s join $table_sql_sub_indicator q  on s.s_id=q.s_id where s.i_id =  $i_id ";
                        ...
                        if (!$result_select_sub_indicator) {
                            ...
                            while ($row_select_sub_indicator = mysqli_fetch_array($result_select_sub_indicator)) {
                                echo "<tr>";
                                echo "<td>" . $row_select_sub_indicator['s_id'] . "</td>";
                                echo "<td>" . $row_select_sub_indicator['s_name'] . "</td>";
                                echo "<td>" . $row_select_sub_indicator['s_goal'] . "</td>";
                                if ($row_select_sub_indicator['q_full'] != NULL) {
                                    ...
                                    echo "<td>" . $row_score_sql['score'] . "</td>";
                                } else {
