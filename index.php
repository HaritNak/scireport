...
<body class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      <li><a class="app-menu__item active" href="index.php"><i class="app-menu__icon fa fa-home"></i><span class="app-menu__label">หน้าหลัก</span></a></li>
      <?php if (isset($_SESSION['id'])) { ?>
        ...
        <?php } ?>
        <li><a class="app-menu__item " href="show_video.php"><i class="app-menu__icon fa fa-youtube-play"></i><span class="app-menu__label">วิดีสอนการใช้งาน</span></a></li>
      <?php } else { ?>
  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="tile">
          <h3 class="tile-title">ระบบรายงานผลการปฏิบัติราชการ</h3>
          <p> &emsp;การจัดทํา แผนปฏิบัติราชการ ประจําปีงบประมาณ โดยได้ดําเนินการตามกระบวนการ ประกอบด้วย การประชุม
            เพื่อทบทวนตัวชี้วัดและค่าเป้าหมายตัวชี้วัด ตามภารกิจหลักของมหาวิทยาลัยประจําปีงบประมาณ
            ซึ่งสามารถใช้เป็นแนวทางในการจัดทําแผนปฏิบัติราชการและเป็นกรอบในการกําหนดกิจกรรมให้สอดรับ เป็นไป ในทิศทางเดียวกัน
            อีกทั้งเพื่อเป็นเครื่องมือสําคัญในการติดตามประเมินผลการดําเนินงานให้เป็นไปตามตัวชี้วัด และเป้าหมายของมหาวิทยาลัย ให้ประสบความสําเร็จและบรรลุเป้าหมายต่อไป</p>

        </div>
      </div>
      <div class="col-md-6">
        <div class="tile">
          <h3 class="tile-title">รายงานสรุปผลดำเนินงาน</h3>
          <p>โดยมีการจัดทำ 4 หัวข้อหลัก ได้แก่</br>
            1.รายการสรุปผลการดำเนินงานตามตัวชี้วัดภารกิจหลัก มหาวิทยาลัยเทคโนโลยีราชมงคลสุวรรณภูมิ
            2.รายการสรุปผลการดำเนินงานตามตัวชี้วัดของสำนักงบประมาณ จำแนกตามเป้าหมายการให้บริการ
            3.รายการสรุปผลการดำเนินงานตามแผนยุทธศาสตร์การพัฒนามหาวิทยาลัยเทคโนโลยีราชมงคลสุวรรณภูมิ</br>
            4.รายการสรุปผลการดำเนินงานตามแผนยุทธศาสตร์คณะวิทยาศาสตร์และเทคโนโลยี</p>
