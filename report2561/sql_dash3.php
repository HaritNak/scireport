...
$sql_report3_title1_no9_2 = "SELECT count(*) as total from `data_student_soft_skill` where col1 != 0 and datee BETWEEN '" . $_POST['date1'] . "' AND '" . $_POST['date2'] . "' ;";
...
$sql_report3_title1_no10_2 = "SELECT sum(cast(col13 as int)) as total, sum(cast(col15 as int)) as pass from `data_student_soft_skill` where col1 != 0 and datee BETWEEN '" . $_POST['date1'] . "' AND '" . $_POST['date2'] . "' ;";
...
$report3_title1_no10_2 = @(ceil($report3_title1_no10_2['pass'] * 100) / $report3_title1_no10_2['total']);
...
$sql_report3_title3_no3_2 = "SELECT count(*) as total from data_publish_works where col1 != 0 and datee BETWEEN '" . $_POST['date1'] . "' AND '" . $_POST['date2'] . "' ;";
