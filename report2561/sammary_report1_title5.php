  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <!-- <div class="tile-body"> -->
          <h3 class="tile-body">การบริการวิชาการ</h3>
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            <tbody>
              ...
              echo "<tr>";
              echo "<td>1</td>";
              echo "<td>" . $report1_title5_no1["oname"] . "</td>";
              echo "<td>" . $report1_title5_no1["goal"] . "</td>";
              echo "<td>" . $report1_title5_no1["present"] . "</td>";
              if ($report1_title5_no1["present"] >= $report1_title5_no1["goal"] && $report1_title5_no1["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report1_title5_no1["present"] < $report1_title5_no1["goal"] && $report1_title5_no1["present"] != 0) {
              ...
              echo "<tr>";
              echo "<td>2</td>";
              echo "<td>" . $report1_title5_no2["oname"] . "</td>";
              echo "<td>" . $report1_title5_no2["goal"] . "</td>";
              echo "<td>" . $report1_title5_no2["present"] . "</td>";
              if ($report1_title5_no2["present"] >= $report1_title5_no2["goal"] && $report1_title5_no2["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report1_title5_no2["present"] < $report1_title5_no2["goal"] && $report1_title5_no2["present"] != 0) {
                echo "<td><button class='btn btn-danger' type='button'>ไม่ผ่าน</button></td>";
              } else {
                echo "<td><button class='btn btn-warning' type='button'>ไม่ทราบ</button></td>";
              }
              ...
              echo "<tr>";
              echo "<td>3</td>";
              echo "<td>" . $report1_title5_no3["oname"] . "</td>";
              echo "<td>" . $report1_title5_no3["goal"] . "</td>";
              echo "<td>" . $report1_title5_no3["present"] . "</td>";
              if ($report1_title5_no3["present"] >= $report1_title5_no3["goal"] && $report1_title5_no3["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report1_title5_no3["present"] < $report1_title5_no3["goal"] && $report1_title5_no3["present"] != 0) {
                echo "<td><button class='btn btn-danger' type='button'>ไม่ผ่าน</button></td>";
              } else {
                echo "<td><button class='btn btn-warning' type='button'>ไม่ทราบ</button></td>";
              }
              ...
              echo "<tr>";
              echo "<td>4</td>";
              echo "<td>" . $report1_title5_no4["oname"] . "</td>";
              echo "<td>" . $report1_title5_no4["goal"] . "</td>";
              echo "<td>" . $report1_title5_no4["present"] . "</td>";
              if ($report1_title5_no4["present"] >= $report1_title5_no4["goal"] && $report1_title5_no4["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report1_title5_no4["present"] < $report1_title5_no4["goal"] && $report1_title5_no4["present"] != 0) {
                echo "<td><button class='btn btn-danger' type='button'>ไม่ผ่าน</button></td>";
              } else {
                echo "<td><button class='btn btn-warning' type='button'>ไม่ทราบ</button></td>";
              }
