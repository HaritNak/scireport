...
$sql_report1_title1_no5_2 = "SELECT sum(cast(col13 as int)) as total, sum(cast(col15 as int)) as pass from `2561data_test_capacity` where col1 != 0;";
...
$report1_title1_no5_2 = ($report1_title1_no5_2['pass'] * 100) / $report1_title1_no5_2['total'];
//ลำดับที่6
