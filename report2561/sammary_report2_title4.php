  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <!-- <div class="tile-body"> -->
          <h3 class="tile-body">เพื่อให้บุคลากร นักศึกษา และประชาชนทั่วไป มีความรู้ความเข้าใจและตระหนักในคุณค่าของศิลปวัฒนธรรมไทยและสิ่งแวดล้อม</h3>
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            <tbody>
              ...
              echo "<tr>";
              echo "<td>1</td>";
              echo "<td>" . $report2_title4_no1["oname"] . "</td>";
              echo "<td>" . $report2_title4_no1["goal"] . "</td>";
              echo "<td>" . $report2_title4_no1["present"] . "</td>";
              if ($report2_title4_no1["present"] >= $report2_title4_no1["goal"] && $report2_title4_no1["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report2_title4_no1["present"] < $report2_title4_no1["goal"] && $report2_title4_no1["present"] != 0) {
              ...
              echo "<tr>";
              echo "<td>2</td>";
              echo "<td>" . $report2_title4_no2["oname"] . "</td>";
              echo "<td>" . $report2_title4_no2["goal"] . "</td>";
              echo "<td>" . $report2_title4_no2["present"] . "</td>";
              if ($report2_title4_no2["present"] >= $report2_title4_no2["goal"] && $report2_title4_no2["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report2_title4_no2["present"] < $report2_title4_no2["goal"] && $report2_title4_no2["present"] != 0) {
                echo "<td><button class='btn btn-danger' type='button'>ไม่ผ่าน</button></td>";
              } else {
                echo "<td><button class='btn btn-warning' type='button'>ไม่ทราบ</button></td>";
              }
              ...
              echo "<tr>";
              echo "<td>3</td>";
              echo "<td>" . $report2_title4_no3["oname"] . "</td>";
              echo "<td>" . $report2_title4_no3["goal"] . "</td>";
              echo "<td>" . $report2_title4_no3["present"] . "</td>";
              if ($report2_title4_no3["present"] >= $report2_title4_no3["goal"] && $report2_title4_no3["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report2_title4_no3["present"] < $report2_title4_no3["goal"] && $report2_title4_no3["present"] != 0) {
                echo "<td><button class='btn btn-danger' type='button'>ไม่ผ่าน</button></td>";
              } else {
                echo "<td><button class='btn btn-warning' type='button'>ไม่ทราบ</button></td>";
              }
              ...
              echo "<tr>";
              echo "<td>4</td>";
              echo "<td>" . $report2_title4_no4["oname"] . "</td>";
              echo "<td>" . $report2_title4_no4["goal"] . "</td>";
              echo "<td>" . $report2_title4_no4["present"] . "</td>";
              if ($report2_title4_no4["present"] >= $report2_title4_no4["goal"] && $report2_title4_no4["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report2_title4_no4["present"] < $report2_title4_no4["goal"] && $report2_title4_no4["present"] != 0) {
                echo "<td><button class='btn btn-danger' type='button'>ไม่ผ่าน</button></td>";
              } else {
                echo "<td><button class='btn btn-warning' type='button'>ไม่ทราบ</button></td>";
              }
              ...
              echo "<tr>";
              echo "<td>5</td>";
              echo "<td>" . $report2_title4_no5["oname"] . "</td>";
              echo "<td>" . $report2_title4_no5["goal"] . "</td>";
              echo "<td>" . $report2_title4_no5["present"] . "</td>";
              if ($report2_title4_no5["present"] >= $report2_title4_no5["goal"] && $report2_title4_no5["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report2_title4_no5["present"] < $report2_title4_no5["goal"] && $report2_title4_no5["present"] != 0) {
                echo "<td><button class='btn btn-danger' type='button'>ไม่ผ่าน</button></td>";
              } else {
                echo "<td><button class='btn btn-warning' type='button'>ไม่ทราบ</button></td>";
              }
              ...
              echo "<tr>";
              echo "<td>6</td>";
              echo "<td>" . $report2_title4_no6["oname"] . "</td>";
              echo "<td>" . $report2_title4_no6["goal"] . "</td>";
              echo "<td>" . $report2_title4_no6["present"] . "</td>";
              if ($report2_title4_no6["present"] >= $report2_title4_no6["goal"] && $report2_title4_no6["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report2_title4_no6["present"] < $report2_title4_no6["goal"] && $report2_title4_no6["present"] != 0) {
                echo "<td><button class='btn btn-danger' type='button'>ไม่ผ่าน</button></td>";
              } else {
                echo "<td><button class='btn btn-warning' type='button'>ไม่ทราบ</button></td>";
              }
              ...
              echo "<tr>";
              echo "<td>7</td>";
              echo "<td>" . $report2_title4_no7["oname"] . "</td>";
              echo "<td>" . $report2_title4_no7["goal"] . "</td>";
              echo "<td>" . $report2_title4_no7["present"] . "</td>";
              if ($report2_title4_no7["present"] >= $report2_title4_no7["goal"] && $report2_title4_no7["present"] != 0) {
                echo "<td><button class='btn btn-success' type='button'>ผ่าน</button></td>";
              } else if ($report2_title4_no7["present"] < $report2_title4_no7["goal"] && $report2_title4_no7["present"] != 0) {
                echo "<td><button class='btn btn-danger' type='button'>ไม่ผ่าน</button></td>";
              } else {
                echo "<td><button class='btn btn-warning' type='button'>ไม่ทราบ</button></td>";
              }
