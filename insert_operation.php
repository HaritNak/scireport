...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-plus-square-o"></i> เพิ่มผลการดำเนินงานปีงบประมาณ<?php echo $fiscal_year ?></h1>

            </div>
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item ">เพิ่มปีงบประมาณ</li>
                <li class="breadcrumb-item active"><a href="#">เพิ่มผลการดำเนินงาน<?php echo $fiscal_year ?></a></li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="tile">
                    <h3 class="tile-title">เพิ่มผลการดำเนินงานปีงบประมาณ<?php echo $fiscal_year ?></h3>
                    <form action="insert_operation_action.php" method="POST">
                        <div class="form-group row">
                            <div class="form-group col-md-10">
                                <input type="text" class="form-control" id="o_name" name="o_name" placeholder="ชื่อผลการดำเนินงาน" required>
                        ...
                        <tbody>
                            ...
                            if (!$result_select_operation) {
                                ...
                                while ($row_select_operation = mysqli_fetch_array($result_select_operation)) {
                                    ...
                                    echo "<td><a href='insert_indicator.php?year= " . $fiscal_year . "&&o_id=" . $row_select_operation['o_id'] . " ' class='btn btn-success' role='button' aria-pressed='true'>เพิ่ม</a></td>";
                                    echo "</tr>";
                                }
                            }
                            ?>
